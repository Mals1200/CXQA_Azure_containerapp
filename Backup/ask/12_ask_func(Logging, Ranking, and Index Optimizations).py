# Logging:
#    Seperated the logging in another function that is called in the Ask_question function.
#        Started to Log
#           1 Time
#           2 Question
#           3 Answer
...
#           5 Src_material(new)
#           6 Chat_Topic(new)
#           7 Chat_History length(new)
#           8 Teams_User_Email(new)   "Requires an edit to app.py. check version(4)"
# Ranking:
#    Added ranking based on the meta data of the index source.
#
# Index multi-layered questions:
#    made the index split use semantic parsing.

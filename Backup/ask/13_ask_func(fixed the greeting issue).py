# The greetings were handled by the Ask_Question function to reply with a greeting if one of the greetings existed with or within a question.
# i.e. "Hi, <user_question>" will be treated as greeting
# and the words "which" and "highest" would trigger the greeting responce because both have the letters H and I togerther and inside the words.
